...
public abstract class Hilt_ElderMedicationFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_ElderMedicationFragment() {
    super();
  }

  Hilt_ElderMedicationFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((ElderMedicationFragment_GeneratedInjector) this.generatedComponent()).injectElderMedicationFragment(UnsafeCasts.<ElderMedicationFragment>unsafeCast(this));
    }
  }
