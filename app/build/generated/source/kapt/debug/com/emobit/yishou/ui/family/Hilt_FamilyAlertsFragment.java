...
public abstract class Hilt_FamilyAlertsFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_FamilyAlertsFragment() {
    super();
  }

  Hilt_FamilyAlertsFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((FamilyAlertsFragment_GeneratedInjector) this.generatedComponent()).injectFamilyAlertsFragment(UnsafeCasts.<FamilyAlertsFragment>unsafeCast(this));
    }
  }
