...
public abstract class Hilt_ElderChatFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_ElderChatFragment() {
    super();
  }

  Hilt_ElderChatFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((ElderChatFragment_GeneratedInjector) this.generatedComponent()).injectElderChatFragment(UnsafeCasts.<ElderChatFragment>unsafeCast(this));
    }
  }
