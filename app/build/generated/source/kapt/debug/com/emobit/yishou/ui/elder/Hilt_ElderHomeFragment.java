...
public abstract class Hilt_ElderHomeFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_ElderHomeFragment() {
    super();
  }

  Hilt_ElderHomeFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((ElderHomeFragment_GeneratedInjector) this.generatedComponent()).injectElderHomeFragment(UnsafeCasts.<ElderHomeFragment>unsafeCast(this));
    }
  }
