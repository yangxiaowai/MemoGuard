...
public abstract class Hilt_FamilyLocationFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_FamilyLocationFragment() {
    super();
  }

  Hilt_FamilyLocationFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((FamilyLocationFragment_GeneratedInjector) this.generatedComponent()).injectFamilyLocationFragment(UnsafeCasts.<FamilyLocationFragment>unsafeCast(this));
    }
  }
