...
public abstract class Hilt_FamilySettingsFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_FamilySettingsFragment() {
    super();
  }

  Hilt_FamilySettingsFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((FamilySettingsFragment_GeneratedInjector) this.generatedComponent()).injectFamilySettingsFragment(UnsafeCasts.<FamilySettingsFragment>unsafeCast(this));
    }
  }
