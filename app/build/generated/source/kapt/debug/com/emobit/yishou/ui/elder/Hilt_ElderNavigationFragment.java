...
public abstract class Hilt_ElderNavigationFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_ElderNavigationFragment() {
    super();
  }

  Hilt_ElderNavigationFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((ElderNavigationFragment_GeneratedInjector) this.generatedComponent()).injectElderNavigationFragment(UnsafeCasts.<ElderNavigationFragment>unsafeCast(this));
    }
  }
