...
public abstract class Hilt_FamilyReportsFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_FamilyReportsFragment() {
    super();
  }

  Hilt_FamilyReportsFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((FamilyReportsFragment_GeneratedInjector) this.generatedComponent()).injectFamilyReportsFragment(UnsafeCasts.<FamilyReportsFragment>unsafeCast(this));
    }
  }
