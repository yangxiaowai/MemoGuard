...
public abstract class Hilt_ElderSettingsFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_ElderSettingsFragment() {
    super();
  }

  Hilt_ElderSettingsFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((ElderSettingsFragment_GeneratedInjector) this.generatedComponent()).injectElderSettingsFragment(UnsafeCasts.<ElderSettingsFragment>unsafeCast(this));
    }
  }
