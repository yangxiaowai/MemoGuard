...
public abstract class Hilt_ElderFindItemFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_ElderFindItemFragment() {
    super();
  }

  Hilt_ElderFindItemFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((ElderFindItemFragment_GeneratedInjector) this.generatedComponent()).injectElderFindItemFragment(UnsafeCasts.<ElderFindItemFragment>unsafeCast(this));
    }
  }
