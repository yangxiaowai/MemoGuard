...
public abstract class Hilt_FamilyDashboardFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_FamilyDashboardFragment() {
    super();
  }

  Hilt_FamilyDashboardFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((FamilyDashboardFragment_GeneratedInjector) this.generatedComponent()).injectFamilyDashboardFragment(UnsafeCasts.<FamilyDashboardFragment>unsafeCast(this));
    }
  }
