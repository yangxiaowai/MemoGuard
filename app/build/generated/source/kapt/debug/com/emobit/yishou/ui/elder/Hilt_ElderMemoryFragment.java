...
public abstract class Hilt_ElderMemoryFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_ElderMemoryFragment() {
    super();
  }

  Hilt_ElderMemoryFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((ElderMemoryFragment_GeneratedInjector) this.generatedComponent()).injectElderMemoryFragment(UnsafeCasts.<ElderMemoryFragment>unsafeCast(this));
    }
  }
